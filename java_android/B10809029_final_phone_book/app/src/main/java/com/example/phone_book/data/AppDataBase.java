...
@Database(entities = {PhoneItemEntry.class}, version = 1, exportSchema = false) //取代 SQL OPENHELPER
...
public abstract class AppDataBase extends RoomDatabase { //抽象繼承 RoomDatabase
    ...
    private static final String DATABASE_NAME = "phon_items";
    ...
    public abstract PhoneItemListDao taskDao();//取得 Dao 物件
}
